...
function CategoryList() {
   ...
   const getCategoryProduct=async()=>{
      try {
         const response=await axios.get(`${import.meta.env.VITE_BASE_URL}/api/v1/products/getProductCategory`,{withCredentials:true})
    ...
    <div className='container mx-auto'>
         {
            loader ? (
             ...
             <div className='flex items-center gap-4 justify-between md:pt-2 pt-24 overflow-scroll scrollbar-hide'>
                  {
