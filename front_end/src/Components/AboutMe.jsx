...
function AboutMe() {
  return (
    <div className='w-full flex flex-col md:flex-row justify-center items-center p-8'>
        <div className="w-full bg-[#00ff99] h-[350px] grid justify-center place-content-center p-4 shadow-lg">
        ...
        <div className="w-full bg-white md:h-[350px] h-[500px] p-8 shadow-lg">
             ...
             <p className='text-lg font-semibold text-justify p-2'>Over 3 month of hands-on internship experience in full-stack development.Proficient in diverse projects including a E-Commerce Management System,E-Learning Back-End System,School-WebApp,Successfully intergrated payment systems like Razorpay.</p>
        </div>
    </div>
  )
}
